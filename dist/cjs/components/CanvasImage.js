...
exports.CanvasImage = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const canvasProps = Object.fromEntries(Object.entries(restProps).filter(([key]) => !key.endsWith("Pixel")));
    const canvasRef = (0, react_1.useRef)(null);
    const [imageSrc, setImageSrc] = (0, react_1.useState)("");
    const [imgMeta, setImgMeta] = (0, react_1.useState)(null);
